      ...
      <div class="relative hidden h-screen my-4 ml-4 shadow-lg lg:block w-80">
        <div class="h-full bg-white rounded-2xl dark:bg-gray-700">
          ...
          <nav class="mt-6">
            <div>
              <Link
                class="flex items-center justify-start w-full p-4 my-2 font-thin text-green -500 uppercase transition-colors duration-200 border-r-4 border-green-500 bg-gradient-to-r from-white to-green-100 dark:from-gray-700 dark:to-gray-800"
               to="stories"
              >
                ...
                <span class="mx-4 text-sm font-normal">Stories</span>
             </Link>
              <Link
                class="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-green-500"
               to="persons"
              >
                <span class="text-left">
                  <svg
                ...
                <span class="mx-4 text-sm font-normal">Persons</span>
             </Link>
              <Link
                class="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-green-500"
               to="places"
              >
                ...
                <span class="mx-4 text-sm font-normal">Places</span>
             </Link>
              <Link
                class="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-green-500"
               to="events"
              ...
              >
                ...
                <span class="mx-4 text-sm font-normal">Chapters</span>
             </Link>
              <Link
                class="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-green-500"
               to="tools"
              >
                ...
                <span class="mx-4 text-sm font-normal">Tools</span>
             </Link>
              <Link
                class="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-green-500"
               to="settings"
